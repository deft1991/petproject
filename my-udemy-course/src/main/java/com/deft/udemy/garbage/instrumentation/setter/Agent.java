...
public class Agent {
    public static void premain(String agentArgs, Instrumentation inst) {
        ...
        inst.addTransformer(new ClassFileTransformer() {
            ...
            public byte[] transform(ClassLoader loader, String className,
                ...
                if (className.equals("com/deft/udemy/garbage/instrumentation/setter/MyClass")) {
    ...
    private static byte[] addMethod(byte[] originalClass) {
        ...
        mv.visitFieldInsn(Opcodes.PUTFIELD, "com/deft/udemy/garbage/instrumentation/setter/MyClass", "value", "I");
