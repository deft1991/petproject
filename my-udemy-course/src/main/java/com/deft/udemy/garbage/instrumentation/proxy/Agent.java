package com.deft.udemy.garbage.instrumentation.proxy;
...
public class Agent {
    public static void premain(String agentArgs, Instrumentation inst) {
        ...
        inst.addTransformer(new ClassFileTransformer() {
            ...
            public byte[] transform(ClassLoader loader, String className,
                ...
                if (className.equals("com/deft/udemy/garbage/instrumentation/proxy/MyClassImpl")) {
    ...
    private static byte[] addProxyMethod(byte[] originalClass) {
        final String originalMethodName = "secureAccess";
        final String proxiedMethodName = "secureAccessProxied";
        ...
        mv.visitVarInsn(Opcodes.ALOAD, 1);
        mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "com/deft/udemy/garbage/instrumentation/proxy/MyClassImpl", proxiedMethodName, "(Ljava/lang/String;)V", false);
